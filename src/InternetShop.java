class InternetShop {
    ...
    public static void main(String[] args) {
        ...
        Product specialOffer = new Product("Krówki", "Wawel2", 6.99, "Łakoć doskonała od jednego z najbardziej cenionych producentów w Polsce", true, new Category("Słodkie", "Łakocie dla wszystkich"), new SpecialOffer(5.59, "od 1 sierpnia 2020", "do 7 sierpnia 2020"));
        ...
        System.out.println(specialOffer.name + " " + specialOffer.producer + " " + specialOffer.price + " PLN \n" + specialOffer.description + " " + specialOffer.availability + " tylko teraz specjalna cena -20%: " + specialOffer.specialOffer.discount + "  PLN " + specialOffer.specialOffer.from+ " " + specialOffer.specialOffer.till + " \nkategoria produktu: " + specialOffer.category.name + " " + specialOffer.description);
