class InternetShop {
    ...
    public static void main(String[] args) {
        ...
        Product specialOffer = new Product("Krówki", "Wawel2", 6.99, "Łakoć doskonała od jednego z najbarrdzej cenionych producentów w Polsce", true, 5.59, new Category("Słodkie", "Łakocie dla wszystkich"), "od 1 sierpnia 2020", "do 7 sierpnia 2020");
